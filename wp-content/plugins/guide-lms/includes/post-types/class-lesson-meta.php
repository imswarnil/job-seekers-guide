...
class Lesson_Meta {
	...
	public static function render_metabox( $post ) {
		...
		?>
		<p>
			<label for="jsl_video_url"><strong><?php esc_html_e( 'Video URL', 'guide-lms' ); ?></strong></label><br>
			...
			<span class="description"><?php esc_html_e( 'YouTube, Vimeo, or direct .mp4 link.', 'guide-lms' ); ?></span>
		</p>
		<p>
			<label for="jsl_duration_minutes"><strong><?php esc_html_e( 'Duration (minutes)', 'guide-lms' ); ?></strong></label><br>
		...
		<p>
			<label>
				...
				<?php esc_html_e( 'Free preview (visible without enrolling)', 'guide-lms' ); ?>
			</label>
		</p>
		<?php
	}
