 ...
 *
 * Course / Lesson / LearningPath schema lives in JSL\Schema\Json_Ld — this
...
class Seo {
	...
	public static function filter_title( $parts ) {
		...
		if ( is_post_type_archive( 'course' ) ) {
			$parts['title'] = __( 'All courses', 'job-seekers-lms' );
		}

		if ( is_post_type_archive( 'learning_path' ) ) {
			$parts['title'] = __( 'Learning paths', 'job-seekers-lms' );
		}
	...
	public static function description(): string {
		...
		if ( is_post_type_archive( 'course' ) ) {
			return __( 'Every course on the platform — interview preparation, résumés, negotiation and more.', 'job-seekers-lms' );
		}

		if ( is_post_type_archive( 'learning_path' ) ) {
			return __( 'Structured learning paths that take you from application to offer, one course at a time.', 'job-seekers-lms' );
		}
